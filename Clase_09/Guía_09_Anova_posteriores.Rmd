...
```{r}
#**H~0~**: $$\mu_{_Tank1} = \mu_{Animal_Tank2} = \mu_{Animal_Tank3} = \mu_{Vegetal_Tank1} = \mu_{Vegetal_Tank2} = \mu_{Vegetal_Tank3}$$
...
**f).** Realice una prueba *a posteriori* de Tukey sobre el objeto anova2. Para esto use la función TukeyHSD(). LLame el objeto Tukey_anova2.
...
- ¿Existen diferencias significativas entre dietas y entre sexos?
